...
export default function Help() {
  return (
    ...
    <ScrollView>
      ...
      <Text style={[styles.tcP, {fontSize: 10}]}>
      ...
      <Text style={[styles.tcP, {fontSize: 12}]}>
      Os dados pessoais do usuário são recolhidos pelo aplicativo CompraemaisAki das seguinte formas:
      </Text>


      <View style={{flexDirection: 'row'}}>
            <Text style={[styles.tcP, {fontSize: 12}]}>{'\u2022'}</Text>
            <Text style={[styles.tcP, {flex: 1, paddingLeft: 5, fontSize: 12}]}>Quando o usuário da empresa se cadastra no aplicativo: esses dados são os dados de identificação básicos de Razão Social, CNPJ, Ramo Empresarial, E-mail, Telefone, Endereço e Imagem da Empresa.</Text>
      </View>

      <View style={{flexDirection: 'row'}}>
            <Text style={[styles.tcP, {fontSize: 12}]}>{'\u2022'}</Text>
            <Text style={[styles.tcP, {flex: 1, paddingLeft: 5, fontSize: 12}]}>Quando o usuário da empresa atualiza seus dados do aplicativo: neste caso o aplicativo pode solicitar os dados de Razão Social, CNPJ, Ramo Empresarial, E-mail, Telefone, Endereço e Imagem da Empresa.</Text>
      </View>

      <View style={{flexDirection: 'row'}}>
            <Text style={[styles.tcP, {fontSize: 12}]}>{'\u2022'}</Text>
            <Text style={[styles.tcP, {flex: 1, paddingLeft: 5, fontSize: 12}]}>Quando um usuário acessa o aplicativo: neste caso o aplicativo pode coletar os dados de localização do usuário ou do local da ocorrência da solicitação, através do Google. Além disso, serão coletados todos os dados preenchidos nos formulários pelo usuário, referentes à cada tipo de serviço solicitado.</Text>
      </View>
      ...
      <View style={{flexDirection: 'row'}}>
            <Text style={[styles.tcP, {fontSize: 12}]}>{'\u2022'}</Text>
            <Text style={[styles.tcP, {flex: 1, paddingLeft: 5, fontSize: 12}]}>Identificar o usuário de modo a garantir que as solicitações sejam abertas corretamente;</Text>
      </View>

      <View style={{flexDirection: 'row'}}>
            <Text style={[styles.tcP, {fontSize: 12}]}>{'\u2022'}</Text>
            <Text style={[styles.tcP, {flex: 1, paddingLeft: 5, fontSize: 12}]}>Facilitar e agilizar as compras de fornecedores de produtos e serviços com sede no Município de Nova Santa Rita;</Text>
      </View>

      <View style={{flexDirection: 'row'}}>
            <Text style={[styles.tcP, {fontSize: 12}]}>{'\u2022'}</Text>
            <Text style={[styles.tcP, {flex: 1, paddingLeft: 5, fontSize: 12}]}>Permitir o acesso do usuário a determinados conteúdos do aplicativo, exclusivo para usuários cadastrados;</Text>
      </View>
      ...
      <View style={{flexDirection: 'row'}}>
            <Text style={[styles.tcP, {fontSize: 12}]}>{'\u2022'}</Text>
            <Text style={[styles.tcP, {flex: 1, paddingLeft: 5, fontSize: 12}]}>Dados que revelem a origem racial ou étnica, as opiniões políticas, as convicções religiosas ou filosóficas, ou a filiação sindical do usuário;</Text>
      </View>

      <View style={{flexDirection: 'row'}}>
            <Text style={[styles.tcP, {fontSize: 12}]}>{'\u2022'}</Text>
            <Text style={[styles.tcP, {flex: 1, paddingLeft: 5, fontSize: 12}]}>Dados genéticos;</Text>
      </View>

      <View style={{flexDirection: 'row'}}>
            <Text style={[styles.tcP, {fontSize: 12}]}>{'\u2022'}</Text>
            <Text style={[styles.tcP, {flex: 1, paddingLeft: 5, fontSize: 12}]}>Dados relativos à saúde do usuário;</Text>
      </View>

      <View style={{flexDirection: 'row'}}>
            <Text style={[styles.tcP, {fontSize: 12}]}>{'\u2022'}</Text>
            <Text style={[styles.tcP, {flex: 1, paddingLeft: 5, fontSize: 12}]}>Dados relativos à vida sexual ou à orientação sexual do usuário;</Text>
      </View>

      <View style={{flexDirection: 'row'}}>
            <Text style={[styles.tcP, {fontSize: 12}]}>{'\u2022'}</Text>
            <Text style={[styles.tcP, {flex: 1, paddingLeft: 5, fontSize: 12}]}>Dados relacionados a condenações penais ou a infrações ou com medidas de segurança conexas.</Text>
      </View>
      ...
      <Text style={[styles.tcP1, {fontSize: 12}]}>
