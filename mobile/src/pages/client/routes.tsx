...
import EditProductOverviewScreen from './EditProductOverviewScreen';
...
export default function Root(){
  ...
  return(
    <Stack.Navigator screenOptions={{ headerShown : false }}>
      ...
      <Stack.Screen name="CompanyProductOverview" component={CompanyProductOverviewScreen} />
      ...
      <Stack.Screen name="EditProductOverview" component={EditProductOverviewScreen} />
    </Stack.Navigator>
  );
}